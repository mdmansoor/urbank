		...
		<div class="main-content">
			...
			<section class="profile-env">
				...
				<div class="col-sm-4">
					...
					<div data-easing="false" data-duration="3" data-suffix="k" data-to="117" data-from="1" data-count=".num" class="xe-widget xe-counter xe-counter-blue">
						<div class="xe-icon">
				...
				<div class="col-sm-4">
					...
					<div data-easing="true" data-duration="4" data-to="2470" data-from="1000" data-count=".num" class="xe-widget xe-counter xe-counter-info">
						<div class="xe-icon">
				...
				<div class="col-sm-4">
					...
					<div data-delay="1" data-easing="true" data-duration="5" data-suffix="%" data-prefix="-," data-to="57" data-from="0" data-count=".num" class="xe-widget xe-counter xe-counter-red">
						<div class="xe-icon">
