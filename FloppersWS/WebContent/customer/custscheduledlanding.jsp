		...
		<div class="main-content">
			...
			<div class="page-title">
				...
				<div class="title-env hidden" id="support_queue_status">
					...
					<div>
						Current Language:<span id="current_language">English</span><label
							id="current_language_code" class="hidden">en-US</label>
					</div>
						...
						<div class="compact marquee">
							...
							<div id="div_start">
								...
								Translate voice messages to:<br> <input type="checkbox"
									...
									class="iswitch iswitch-secondary" checked>English<br>
