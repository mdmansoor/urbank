...
public class custapointmentbookingbean extends ActionSupport implements
		ServletRequestAware {
	/**
	 * 
	 */
	...
	public String execute() throws Exception {
		...
		if (map.get(Constants.RESULT).equals(Constants.SUCCESS)) {
			...
			addActionMessage("Your Appointment has been schedule with executive on "
					+ hour + ":" + minute);
			addActionMessage("Event Id " + map.get("EventID"));
			return SUCCESS;
		} else
			return ERROR;
	}
