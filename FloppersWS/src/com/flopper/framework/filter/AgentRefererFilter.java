...
/**
 * Servlet Filter implementation class AgentRefererFilter
 */
public class AgentRefererFilter implements Filter {

    /**
     * Default constructor. 
     */
    public AgentRefererFilter() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		int i = pgm.length;
		if (pgm[3].equals("agentlogin.jsp"))
